...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(false)
    alert("Login functionality will be connected to a backend")
  }
      ...
      <div className="flex flex-col justify-center px-8 py-12 lg:px-16">
        <div className="mx-auto w-full max-w-md">
          ...
          <Link href="/" className="block mb-8">
            <span className="font-serif text-3xl tracking-[0.15em] font-semibold text-primary">GLAMOUR</span>
          </Link>
      ...
      <div className="hidden lg:block relative bg-secondary">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-12 text-primary-foreground">
          <blockquote className="text-2xl font-serif leading-relaxed mb-4">
            "The best beauty products I've ever used. GLAMOUR has completely transformed my skincare routine."
          </blockquote>
          <div>
